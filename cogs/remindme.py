...
reminderjson = "data/remindme/reminders.json"
reminderlog = "data/remindme/reminders.log"
...
class RemindMe:
    ...
    def __init__(self, bot):
        self.bot = bot
        self.reminders = fileIO(reminderjson, "load")
    ...
    async def remindme(self, ctx,  quantity : int, time_unit : str, *, text : str):
        ...
        fileIO(reminderjson, "save", self.reminders)
...
def setup(bot):
    ...
    if logger.level == 0: # Prevents the logger from being loaded again in case of module reload
        ...
        handler = logging.FileHandler(filename=reminderlog, encoding='utf-8', mode='a')
